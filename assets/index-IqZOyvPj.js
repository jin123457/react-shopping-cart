...
const Button$1 = ({ variant = "primary", size = "full", onClick, children }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Button$2, { styles: { variant, size }, onClick, disabled: variant === "disabled", children });
};
...
CartItem.Information = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Information$1, { direction, gap, children });
};
CartItem.Title = ({ text }) => {
...
const CartItemList = ({ cartItemListProps }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$2, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CheckBox, { isChecked: isAllChecked, onClick: () => handleCheckChange({ action: "all" }), children: "전체선택" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(List, { children: cartItems.map((item) => {
      const { id: id2, isChecked, quantity, product } = item;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(CartItem, { gap: 12, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CartItem.Top, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CheckBox, { isChecked, onClick: () => handleCheckChange({ id: id2, action: "each" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "secondary", size: "auto", onClick: () => handleCartItemChange({ id: id2, action: "delete" }), children: "삭제" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CartItem.Content, { gap: 24, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartItem.Image, { src: product.imageUrl, alt: product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CartItem.Information, { gap: 24, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CartItem.Information, { gap: 4, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CartItem.Title, { text: product.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CartItem.Price, { price: product.price })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              QuantityRegulator,
              {
                ...
                handleDecrease: () => handleCartItemChange({ id: id2, action: "patch", quantity: quantity - 1 }),
                handleIncrease: () => handleCartItemChange({ id: id2, action: "patch", quantity: quantity + 1 })
              }
            )
          ] })
        ] })
...
const apiClient = async ({ url, options, params }) => {
  ...
  try {
    ...
    if (e2 instanceof TypeError && e2.message.includes("fetch")) {
      throw new Error(NETWORK_ERROR_MESSAGE);
    }
    if (e2 instanceof Error)
      throw new Error(e2.message || DEFAULT_ERROR_MESSAGE);
...
const cartApi = {
  ...
  delete: async ({ id: id2 }) => {
    return apiClient({ url: `/cart-items/${id2}`, options: { method: "DELETE" } });
  }
};
...
function ErrorProvider({ children }) {
  ...
  const removeError = reactExports.useCallback((id2) => {
    setErrors((prev2) => prev2.filter((error) => error.id !== id2));
  }, []);
...
const useCartApi = () => {
  ...
  const patchCartItem = async ({ id: id2, quantity }) => {
    try {
      await cartApi.patch({ id: id2, quantity });
      getCartItems();
    } catch (e2) {
      if (e2 instanceof Error)
        showError(e2.message);
  ...
  const deleteCartItem = async ({ id: id2 }) => {
    try {
      await cartApi.delete({ id: id2 });
      getCartItems();
    } catch (e2) {
      if (e2 instanceof Error)
        showError(e2.message);
...
const useCartSelection = (cartItems) => {
  const [checkedIds, setCheckedIds] = reactExports.useState(() => new Set(cartItems.map((item) => item.id)));
  const cartItemsWithCheck = cartItems.map((item) => ({
    ...item,
    isChecked: checkedIds.has(item.id)
  }));
  const handleCheckChange = ({ action, id: id2 }) => {
    if (action === "all") {
      const isAllChecked2 = cartItems.every((item) => checkedIds.has(item.id));
      if (isAllChecked2) {
...
const useCart = () => {
  ...
  const handleCartItemChange = ({ action, id: id2, quantity }) => {
    if (action === "patch")
      patchCartItem({ id: id2, quantity });
    if (action === "delete")
      deleteCartItem({ id: id2 });
  };
  reactExports.useEffect(() => {
    getCartItems();
  }, []);
...
const OrderPrice$1 = newStyled.div`
  width: 100%;
  display: flex;
  flex-direction: ${(props) => props.direction};
  gap: ${(props) => `${props.gap}px`};
...
const Description = newStyled.div`
  ...
  gap: 8px;
`;
const OrderPrice = ({ children, direction = "column", gap = 0 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPrice$1, { direction, gap, children });
};
OrderPrice.Wrap = ({ children, direction = "column", gap = 0 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Wrap, { direction, gap, children });
};
OrderPrice.LabelWithPrice = ({ label, price }) => {
...
function OrderList({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderPrice, { gap: 12, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPrice.Description, { text: "총 주문 금액이 100,000원 이상일 경우 무료 배송이 됩니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(OrderPrice.Wrap, { gap: 8, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPrice.LabelWithPrice, { label: "주문 금액", price: cartItemsInfo.orderPrice }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderPrice.LabelWithPrice, { label: "배송비", price: cartItemsInfo.deliveryPrice })
    ] }),
...
const CartPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$3, { children: [
    ...
    cartItemsInfo.cartItemsCount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Information$2, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(OrderList, { cartItemsInfo })
...
const OrderConfirmPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Information, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { variant: "title-1", children: "주문확인" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonWrap, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "disabled", onClick: () => {
    }, children: "결제하기" }) })
  ] });
};
function App() {
...
async function enableMocking() {
  const { worker } = await __vitePreload(() => import("./browser-gQOlTUGe.js"), true ? [] : void 0);
  return worker.start({
    serviceWorker: {
